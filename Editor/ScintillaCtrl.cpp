...
{
  return Call(SCI_GETAUTOMATICFOLD, 0, 0, bDirect);
}
...
{
  return Call(SCI_AUTOCGETORDER, 0, 0, bDirect);
}
...
{
  return Call(SCI_ALLOCATEEXTENDEDSTYLES, static_cast<WPARAM>(numberStyles), 0, bDirect);
}
...
{
  return Call(SCI_GETSELECTIONEMPTY, 0, 0, bDirect);
}
...
{
  return Call(SCI_GETCARETLINEVISIBLEALWAYS, 0, 0, bDirect);
}
...
{
  return Call(SCI_GETLINEENDTYPESALLOWED, 0, 0, bDirect);
}

int CScintillaCtrl::GetLineEndTypesActive(BOOL bDirect)
{
  return Call(SCI_GETLINEENDTYPESACTIVE, 0, 0, bDirect);
}

int CScintillaCtrl::GetLineEndTypesSupported(BOOL bDirect)
{
  return Call(SCI_GETLINEENDTYPESSUPPORTED, 0, 0, bDirect);
}

int CScintillaCtrl::AllocateSubStyles(int styleBase, int numberStyles, BOOL bDirect)
{
  return Call(SCI_ALLOCATESUBSTYLES, static_cast<WPARAM>(styleBase), static_cast<LPARAM>(numberStyles), bDirect);
}

int CScintillaCtrl::GetSubStylesStart(int styleBase, BOOL bDirect)
{
  return Call(SCI_GETSUBSTYLESSTART, static_cast<WPARAM>(styleBase), 0, bDirect);
}

int CScintillaCtrl::GetSubStylesLength(int styleBase, BOOL bDirect)
{
  return Call(SCI_GETSUBSTYLESLENGTH, static_cast<WPARAM>(styleBase), 0, bDirect);
}
...
{
  return Call(SCI_DISTANCETOSECONDARYSTYLES, 0, 0, bDirect);
}

int CScintillaCtrl::GetSubStyleBases(char* styles, BOOL bDirect)
{
  return Call(SCI_GETSUBSTYLEBASES, 0, reinterpret_cast<LPARAM>(styles), bDirect);
}
